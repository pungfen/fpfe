...
export type ConfigNames = 'fp/typescript__typescript-eslint/base' | 'fp/typescript__typescript-eslint/eslint-recommended' | 'fp/typescript__typescript-eslint/recommended' | 'fp/typescript'
