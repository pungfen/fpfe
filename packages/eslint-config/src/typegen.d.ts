...
type UnusedImportsNoUnusedVars = []|[(("all" | "local") | {
  ...
  export type ConfigNames = 'fp/ignores' | 'fp/js' | 'fp/js/unused-imports' | 'fp/perfectionist' | 'fp/imports' | 'fp/typescript > typescript-eslint/base' | 'fp/typescript > typescript-eslint/eslint-recommended' | 'fp/typescript > typescript-eslint/strict-type-checked' | 'fp/typescript > typescript-eslint/base' | 'fp/typescript > typescript-eslint/eslint-recommended' | 'fp/typescript > typescript-eslint/stylistic-type-checked' | 'fp/typescript'
